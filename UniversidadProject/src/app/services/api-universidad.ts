...
export class ApiUniversidad {
    ...
    // ─── MATRÍCULAS ─────────────────────────────────────────
    obtenerMatriculas() {
        return this.httpClient.get<Matricula[]>(`${this.apiUrl}/Matriculas`);
    }
    obtenerMatriculasPorEstudiante(estudianteId: number) {
        return this.httpClient.get<Matricula[]>(`${this.apiUrl}/Matriculas/estudiante/${estudianteId}`);
    }
    obtenerPromediosPorEstudiante() {
        return this.httpClient.get<PromedioEstudiante[]>(`${this.apiUrl}/Matriculas/promedios`);
    }
    agregarMatricula(matricula: Matricula) {
        return this.httpClient.post<any>(`${this.apiUrl}/Matriculas`, matricula);
    }
    actualizarNota(matriculaId: number, nota: number) {
        return this.httpClient.put<any>(`${this.apiUrl}/Matriculas/${matriculaId}/nota`, nota);
    }
    inactivarMatricula(id: number) {
        return this.httpClient.delete<any>(`${this.apiUrl}/Matriculas/${id}`);
    }

    // ─── ESTADÍSTICAS ───────────────────────────────────────
    obtenerEstadisticasGenerales() {
        return this.httpClient.get<EstadisticaGenerales>(`${this.apiUrl}/Matriculas/estadisticas`);
    }
}
